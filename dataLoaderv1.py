...
mill_list = []
final_df = pd.DataFrame(columns=['millName','conetip_Nondefect','conetip_Defect','conetip_total', 'defectPercen_CT','last_ctAt','uv_Nondefect','uv_Defect','uv_total', 'defectPercen_UV','last_uvAt' ,'lastactive'])
...
def updatedData():
        ...
        for i in all_keys.val():
                try:
                        ...
                        data = [i,conetip_Nondefect,conetip_Defect,(conetip_Nondefect + conetip_Defect), defectPercen_CT,last_ctAt,uv_Nondefect,uv_Defect,(uv_Nondefect + uv_Defect), defectPercen_UV,last_uvAt,lastactive ]
